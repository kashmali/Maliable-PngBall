...
public class FormulaPanel extends JPanel 
{
   ...
   * with a GroupLayout.
   * 
   * @param JFrame parent This allows for the usage of the ActionListener in the InfoFrame class.<br>
  ...
  public FormulaPanel (JFrame parent)
  {
    ...
    JLabel lineEight = new JLabel ("Momentum = mass * velocity");
    JLabel lineNine = new JLabel ("Gravitaional Constan; G = 9.8 m/(s^2)"); 
