...
public class CollisionResponse {
   ...
   /**
    * Return the x-position after impact. <br>
    * If statement checks if the time is not negative, leaving a small value just in case.
    * 
   ...
   /**
    * Return the y-position after impact. <br>
    * If statement checks if the time is not negative, leaving a small value just in case.
    * 
   ...
   public double getImpactY(float currentY, float speedY) {
     ...
     /**
   * Accessor method for the variabe t
   * 
