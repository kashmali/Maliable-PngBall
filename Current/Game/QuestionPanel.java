...
import gameFiles.GameEngine;

/**
 * Panel that will display a question for the user to answer. It gets questions from the question manager.
 * @author Jason P'ng
 * @author Aakash Mali
...
public class QuestionPanel extends JPanel implements ActionListener
{
  ...
  Question question;
  /**
   * The JFrame that his panel is on.
   */
  JFrame parent;
  
  /**
   * The constructor. A new question is pulled each time this panel is created. <br>
   * for loops used to layout out the labels one after another.
   * 
   * @param JFrame parent the JFrame this panel is on. The actionPerformed method is used from the parent.
   * @param Font headingFont the font used for headings.
   * @param JLabel headingOne Labels the question.
   * @param JLabel headingtwo Labels the options.
   * @param JLabel headingThree Labels the answer textfield.
   * @param Font lineFont font used for the question and options.
   * @param JLabel[] questionLabels labels used to display the question and options.
   * @param JLabel lineTen tells the user instructions about answering questions.
   * @param JButton answerButton button for the user to submit their answer.
   * @param GroupLayout layout layout used to organize labels and buttons.
   */ 
  ...
  /**
   * Implementation of actionListner. This is used to add fuctionality to the check button and check and user's answer. <br>
   * if structure is used to make sure that the check button was pressed and the action wasn' from another source.
   * 2nd if structure determines if the answer was correct.
   * 
   * @param ActionEvent ae the action that triggers this method to be called.
   * @param String answer the text found in the answer text field
   */
